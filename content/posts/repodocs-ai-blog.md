...
![Three API services documented in three different formats, with no sync between them](/blog/images/repodocs-hero.svg)
...
![RepoDocs AI system layers: templates, prompt packs, validation, published example](/blog/images/repodocs-system-layers.svg)
...
![RepoDocs AI DX Scorecard — March 2026 self-assessment results](/blog/images/repodocs-scorecard.svg)
